...
class CameraDevice8081: public CameraDevice    {
public:
    ...
    virtual ~CameraDevice8081() = default;

	explicit CameraDevice8081(DEVSELINFO *devSelInfo, DEVINFORMATION *deviceInfo);
	explicit CameraDevice8081(DEVSELINFO *devSelInfo, DEVINFORMATION *deviceInfo, COLOR_BYTE_ORDER colorByteOrder);
