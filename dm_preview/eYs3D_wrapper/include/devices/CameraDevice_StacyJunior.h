...
class CameraDeviceStacyJunior: public CameraDevice    {
public:
    ...
    virtual ~CameraDeviceStacyJunior() = default;

	explicit CameraDeviceStacyJunior(DEVSELINFO *devSelInfo, DEVINFORMATION *deviceInfo);
	explicit CameraDeviceStacyJunior(DEVSELINFO *devSelInfo, DEVINFORMATION *deviceInfo, COLOR_BYTE_ORDER colorByteOrder);
