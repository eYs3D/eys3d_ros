...
#ifndef EYS3D_CAMERA_H_
#define EYS3D_CAMERA_H_
#pragma once
...
#include "eys3d_depth/device/device_info.h"
#include "eys3d_depth/device/image.h"
#include "eys3d_depth/device/open_params.h"
...
class EYS3D_API Camera {
 public:
  ...
  /** set max infrared(IR) intensity [6, 15] default 6*/
  void SetIRMaxValue(const std::uint16_t &value);
