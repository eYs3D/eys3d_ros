...
#ifndef EYS3D_TYPES_DATA_H_
#define EYS3D_TYPES_DATA_H_
#pragma once
...
#define EYS3D_IMU_ACCEL 1
#define EYS3D_IMU_GYRO 2
#define EYS3D_IMU_ACCEL_GYRO_CALIB 11

/**
 * @ingroup datatypes
 * @brief Imu data
 */
struct EYS3D_API ImuData {
  /**
   * Data type
   *   EYS3D_IMU_ACCEL: accelerometer
   *   EYS3D_IMU_GYRO: gyroscope
   *   EYS3D_IMU_ACCEL_GYRO_CALIB: calib accelerometer and gyroscope
   * */
  std::uint8_t flag;
  ...
  /** Imu quaternion data for W, X, Y, Z */
  float quaternion[4];
  ...
  void Reset() {
    ...
    std::fill(quaternion, quaternion + 4, 0);
  }
...
#define EYS3D_PROPERTY(TYPE, NAME) \
 public:                             \
...
class EYS3D_API Version {
 public:
  ...
  EYS3D_PROPERTY(value_t, major)
  EYS3D_PROPERTY(value_t, minor)
};

/**
 * Hardware version.
 */
class EYS3D_API HardwareVersion : public Version {
 public:
  ...
  EYS3D_PROPERTY(flag_t, flag)
};

/**
 * Type.
 */
class EYS3D_API Type {
 public:
  using size_t = std::size_t;
  ...
  EYS3D_PROPERTY(value_t, vendor)
  EYS3D_PROPERTY(value_t, product)
};
